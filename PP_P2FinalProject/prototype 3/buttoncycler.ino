...
/*this example was taken from the Adafruit_NeoPixel library found at https://github.com/adafruit/Adafruit_NeoPixel
which we used to work with RGB leds */
